        ...
        try {
            switch (choice) {
                ...
                case '2': {
                    ...
                    books.forEach((book) => {
                        console.log(`ID: ${book.id}, Название: ${book.title}, Автор: ${book.author}, Год: ${book.year}, Жанр: ${book.genre}`);
                    });
                    break;
                }
                ...
                case '3': {
                    ...
                    const updatedBook = await updateBook(parseInt(id, 10), updatedData);
